...
\begin{itemize}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth, keepaspectratio]{img/warning_room.png}
        \centering
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth, keepaspectratio]{img/change_work.png}
        \centering
        \caption{Lệnh chuyển đổi sang chế độ "hoạt động"}
    \end{figure}

    \begin{figure}[H]
        \includegraphics[width=\textwidth, keepaspectratio]{img/change_safe.png}s
        \centering
